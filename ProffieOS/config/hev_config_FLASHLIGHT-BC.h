...
BladeConfig blades[] = {
{0, DimBlade(20.0, SubBlade (1, 11, WS281XBladePtr<12, blade2Pin, Color8::GRB, PowerPINS<bladePowerPin2, bladePowerPin3> >()) ),
SubBlade (0,0, NULL),
DimBlade(20.0, WS281XBladePtr<10, bladePin, Color8::GRB, PowerPINS<bladePowerPin1> >()),
CONFIGARRAY(armor)}
// { 0,
