...
// Play press.wav (like a click sound or similar) when buttons pressed WHEN OFF ONLY.
// Sound will not play when saber is on.
 #define BC_BUTTON_CLICKER
...
//#define ENABLE_SERIAL //Bluetooth ... other commands show?
...
aa_Kyberphonic/The_Duel/Ronin;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU
aa_JayDalorian/OdaNobunaga;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU
aa_HarrySolo/Ronins_Path;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU
a_BAYLAN_SKOLL/Skoll;ProffieOS_V2_Voicepack_Skoll/common;commonBU
aa_KSith/ScrapTec-BC;ProffieOS_V2_Voicepack_Starkiller/common
aa_Kyberphonic/Great_Mother_V2;ProffieOS_V2_Voicepack_Nightsisters/common;commonBU - BC blade Style
aa_Syndicate/Synergy;ProffieOS_V2_Voicepack_Kylo_V2/common;commonBU- BC blade style - Preons matched to sounds
...
aa_JayDalorian/Parsec1;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU
aa_JayDalorian/Nexus;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU
aa_BK/The_Wicked;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU
aa_Greyscale/Stitched_Greyscale;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU
...
// { "aa_Kyberphonic/The_Duel/Ronin;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU", "aa_Kyberphonic/The_Duel/tracks/track2.wav",
// StylePtr<Layers<
//   ColorSelect<Variation,TrInstant,Red,Green,Blue,StyleFire<HaltRed,Amber>,White,Yellow>,
//   TransitionEffectL<TrConcat<TrInstant,BrownNoiseFlicker<Blue,Black,400>,TrDelay<5000>>,EFFECT_RETRACTION>,
//   TransitionEffectL<TrConcat<TrInstant,Blinking<Magenta,Blue,200,500>,TrDelay<3000>>,EFFECT_PREON>,
//   TransitionEffectL<TrConcat<TrInstant,White,TrDelay<1000>>,EFFECT_IGNITION>,
//   InOutTrL<TrWipe<2000>,TrWipeIn<2000>>,
//   TransitionEffectL<TrConcat<TrInstant,Yellow,TrDelay<2000>>,EFFECT_POSTOFF>>>(),
...
// //   // On-Demand
// //   TransitionEffectL<TrConcat<TrWipeIn<1500>,Amber,TrWipe<1500>>,EFFECT_BLADEIN>,
// //   TransitionEffectL<TrConcat<TrInstant,Blinking<White,Black,300,500>,TrDelay<3000>>,EFFECT_BLADEOUT>,
// //     OnDemandVolumeLevel,
...
// // In-Out
//     BC_Bend5_NoSpark_WavOUT_NoSpark_WavIN,
//   // Postoff Emitter Cooldown
//   TransitionEffectL<TrConcat<TrInstant,AlphaL<Rgb<255,50,50>,Bump<Int<0>,Int<3500>>>,TrFadeX<Percentage<WavLen<>,25>>,AlphaL<Red,Bump<Int<0>,Int<2000>>>,TrFadeX<Percentage<WavLen<>,25>>,AlphaL<Rgb<100,0,0>,Bump<Int<0>,Int<1000>>>,TrFadeX<Percentage<WavLen<>,50>>>,EFFECT_POSTOFF>,
//   // On-Demand
//     OnDemandVolumeLevel,
...
Preset bladein [] = {
                                                                ...
                                                                // { "11-CRUCIBLE;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU", "aa_JayDalorian/OdaNobunaga/tracks/sharingan.wav",
                                                                //   StylePtr<Layers<
                                                                //     AudioFlicker<RotateColorsX<Variation,Red>,RotateColorsX<Variation,Rgb<128,0,0>>>,
                                                                //     BC_effects_Red,
                                                                //     TransitionEffectL<TrConcat<TrDelayX<Percentage<WavLen<EFFECT_RETRACTION>,75>>,TrFadeX<Percentage<WavLen<EFFECT_RETRACTION>,25>>,AudioFlickerL<White>,TrInstant>,EFFECT_RETRACTION>,
...
// { "a_STARKILLER/Starkiller1", "a_STARKILLER/tracks/Starkillers_Theme.wav", // 666 in
  // StylePtr<Layers<
  //   Rgb<30,30,30>,
...
//   /* Ice EFFECT_USER2 */
//   TransitionEffectL</* blade turns solid cold 1000ms before ice full coverage */ TrConcat</* hidden by ice overlay at this point, so no reason to have anything more than 1000 before back to Base color */ TrFade<1000>,Rgb<10,0,75>,TrDelay<1>>,EFFECT_USER2>,
//   /*wipe in stripes ice freezing effect */
//   TransitionEffectL<TrConcat</* Stripes fade to solid over remaining 4 seconds from freezing edge's finish until 12000 then hold for next joined delay to end at 15000, so 3000 more. 
...
//   TrWipe<1000>,TransitionEffect<Stripes<10000,-1000,Rgb<50,75,165>,Rgb<25,37,82>,Rgb<50,75,165>,Rgb<13,19,41>>,Sparkle<Rgb<100,150,230>,Rgb<100,200,255>,50,300>,TrFade<1000>,TrDelay<1000>,EFFECT_USER2>,TrDelay<1>,Sparkle<Rgb<100,150,230>,Rgb<100,200,255>,50,300>,TrJoin<TrWipe<1000>,TrSmoothFade<1500>>>,EFFECT_USER2>,
//   /* Freeze */
//   TransitionEffectL<TrConcat</* burst 
//                                                                                                    Thaw 
//                                                                                                    burst */
//   TrJoin</* leading freeze edge 
//                                                                                                    crystalizing in edge's wake */
//   TrWaveX<BrownNoiseFlicker<Rgb<100,200,255>,DeepSkyBlue,60>,Int<400>,Int<50>,Int<1000>,Int<0>>,TrWaveX<BrownNoiseFlicker<Rgb<100,200,255>,SteelBlue,600>,Int<1000>,Int<400>,Int<1000>,Int<0>>,TrWaveX<Sparkle<AlphaL<Rgb<100,200,255>,Int<0>>,Rgb<100,200,255>,3000,200>,Int<1000>,Int<100>,Int<1000>,Int<-7000>>>,TrJoin</* crystalizing in thaw's path 
//                                                                                                    leading thawing edge */
//   TrWaveX<BrownNoiseFlicker<Rgb<100,200,255>,DeepSkyBlue,300>,Int<300>,Int<50>,Int<1000>,Int<0>>,TrWaveX<Sparkle<AlphaL<Rgb<100,200,255>,Int<0>>,Rgb<100,200,255>,3000,200>,Int<2000>,Int<300>,Int<1000>,Int<3000>>,TrWaveX<BrownNoiseFlicker<DarkOrange,Yellow,80>,Int<2000>,Int<400>,Int<1000>,Int<0>>>>,EFFECT_USER2>,


// BC ADD EffectDecrementF so this can go backwards. NOPE JUST DO -1 using SUM because modelo...yeah.
StylePtr<Layers<Red,
  // ColorSelect<AltF,TrInstant,
  //   ColorSelect<Variation,TrInstant,Amber,BlueRibbon,BrainFreeze,BrutalPink,BusyBee,CanaryYellow,CathodeGreen,CyberYellow,ElectricBanana,ElectricLime,ElectricPurple,ElectricViolet,Flamingo,HaltRed,HotMagenta,ImperialYellow,Lemon,LimeZest,Limoncello,MasterSwordBlue,MintyParadise,MoltenCore,NeonRose,Orange,OrangeJuice,OverdueBlue,PaleGreen,PlungePool,PsychedelicPurple,RareBlue,SafetyOrange,SchoolBus,Star,SuperSaiyan,VibrantMint,ViolentViolet,VividRaspberry,VividViolet,ZeusBolt>
  // ,Blinking<Green,Black,1000,500>,Blinking<Blue,Black,1000,500>,Blinking<Yellow,Black,1000,500>,Blinking<Cyan,Black,1000,500>>,
  ...
  //  // TransitionEffectL<TrDoEffectX<TrInstant,EFFECT_ALT_SOUND,EffectDecrementF<EFFECT_USER1,Int<5>>>,EFFECT_USER1>,  // Decrement by 1, range 1-5
  //  // TransitionEffectL<TrDoEffectX<TrInstant,EFFECT_ALT_SOUND,EffectIncrementF<EFFECT_USER2,Int<5>>>,EFFECT_USER2>,  // Increment by 1, range 1-5
   TransitionEffectL<TrConcat<TrWipe<100>,Blue,TrDelayX<WavLen<EFFECT_ACCENT_SLASH>>>,EFFECT_ACCENT_SLASH>,

  //   BC_effects_1,
  // TransitionEffectL<TrConcat<TrWipe<200>,White,TrWipe<200>>,EFFECT_ACCENT_SWING>,
  // TransitionEffectL<TrConcat<TrWipe<200>,Blue,TrWipe<200>>,EFFECT_ACCENT_SLASH>,
// In-Out
  InOutTrL<TrWipe<500>,TrWipeInX<WavLen<EFFECT_RETRACTION>>>,
  TransitionEffectL<TrConcat<TrWipe<100>,Chartreuse,TrDelayX<WavLen<EFFECT_PREON>>>,EFFECT_PREON>,
  TransitionEffectL<TrConcat<TrWipe<100>,Blue,TrDelayX<WavLen<EFFECT_POSTOFF>>>,EFFECT_POSTOFF>,
  //     InOutTrL</* OUT 
//    IN */
// TrJoin<TrWipeX<BendTimePowInvX<Int<1500>,Int<135000>>>,TrSparkX<White,Int<400>,BendTimePowInvX<Int<1500>,Int<110000>>,Int<1600>>>,TrWipeInX<BendTimePowX<WavLen<EFFECT_RETRACTION>,Int<180000>>>,Layers<
//   Pulsing<Rgb<5,0,0>,Rgb<20,0,0>,3000>,
...
{ "testfont2b;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "a_STARKILLER/tracks/Starkillers_Theme.wav", // 666 in
  // StylePtr<Layers<
  //   Rgb<30,30,30>,
// AudioFlicker<BrownNoiseFlicker<RotateColorsX<Variation,Red>,RotateColorsX<Variation,Rgb<60,0,0>>,500>,RotateColorsX<Variation,Rgb<128,0,0>>>,
//   /* Ice EFFECT_USER2 */
...
// BC ADD EffectDecrementF so this can go backwards. NOPE JUST DO -1 using SUM because modelo...yeah.
StylePtr<
Layers<Red, AlphaL<Blue,Int<16000>>,
...
// // In-Out
//   InOutTrL<TrWipe<500>,TrWipeInX<WavLen<EFFECT_RETRACTION>>>,
//   TransitionEffectL<TrConcat<TrWipe<100>,BlanchedAlmond,TrDelayX<WavLen<EFFECT_PREON>>>,EFFECT_PREON>,
//   TransitionEffectL<TrConcat<TrWipe<100>,Blue,TrDelayX<WavLen<EFFECT_POSTOFF>>>,EFFECT_POSTOFF>,
//   //     InOutTrL</* OUT 
// //    IN */
// // TrJoin<TrWipeX<BendTimePowInvX<Int<1500>,Int<135000>>>,TrSparkX<White,Int<400>,BendTimePowInvX<Int<1500>,Int<110000>>,Int<1600>>>,TrWipeInX<BendTimePowX<WavLen<EFFECT_RETRACTION>,Int<180000>>>,Layers<
...
// { "aa_HarrySolo/Ronins_Path;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU", "tracks/FallenOrderTracks/JFO9.wav",
//   StylePtr<Layers<
...
// { "aa_KSith/ScrapTec-BC;ProffieOS_V2_Voicepack_Starkiller/common", "aa_KSith/ScrapTec/tracks/ScrapTec_track.wav",
...
//    { "aa_Kyberphonic/Great_Mother_V2;ProffieOS_V2_Voicepack_Nightsisters/common;commonBU", "aa_Kyberphonic/Great_Mother_V2/tracks/track1.wav",
//     StylePtr<Layers<Black,
...
// { "aa_BK/The_Wicked;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU", "aa_BK/The_Wicked/wick-trk.wav",
//   StylePtr<Layers<
...
// { "a_INQUISITOR/2ndSistr;ProffieOS_V2_Voicepack_Vader_V2/common;commonBU", "tracks/FallenOrderTracks/JFO5.wav",
// //Second Sister Base Red
//   StylePtr<Layers<
...
// { "a_STARKILLER/Secret_Apprentice;ProffieOS_V2_Voicepack_Starkiller/common;commonBU", "a_STARKILLER/tracks/SKT4.wav", // AudioFlicker Red Base Color Wheel Changeable
//   StylePtr<Layers<
//     AudioFlicker<BrownNoiseFlicker<RotateColorsX<Variation,Red>,RotateColorsX<Variation,Rgb<60,0,0>>,500>,RotateColorsX<Variation,Rgb<128,0,0>>>,
//         // Ice Force
//     TransitionEffectL< 
...
// // { "aa_Blueforce/IgnitionUltimate;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU", "",
// // StylePtr<Layers<
...
// // { "GhostsOfTheGrey;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU", "", 
// //   StylePtr<Layers<
...
// { "aa_LordBlako/PitchBlk;ProffieOS_V2_Voicepack_Starkiller/common;commonBU", "tracks/MSV.wav",
// //Second Sister Base Red
//   StylePtr<Layers<
...
// // { "a_PONG_KRELL/PongKrll;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU", "a_PONG_KRELL/tracks/Krell.wav",
// //   StylePtr<Layers<
...
// // { "Proto2;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU", "Proto2/tracks/proto2.wav", // Color Cycle to Glitchy Pulsing Blade Default = Green
// //   StylePtr<Layers<   
...
// { "PsyBorg;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU", "tracks/FallenOrderTracks/JFO7.wav",
//   StylePtr<Layers<
...
// // { "a_DARKSABER/DarkV3;ProffieOS_V2_Voicepack_The_Ronin/common;commonBU", "a_DARKSABER/DarkV3/tracks/Mandalorian.wav",
// //   StylePtr<Layers<
